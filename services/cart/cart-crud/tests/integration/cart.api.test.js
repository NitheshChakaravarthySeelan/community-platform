...
describe("Cart API", () => {
    ...
    it("should add an item to the cart", async () => {
        ...
        expect(mockCartService.addItem).toHaveBeenCalledWith(userId, newItem.productId, newItem.quantity);
    });
    it("should update an item quantity", async () => {
        ...
        expect(mockCartService.updateItemQuantity).toHaveBeenCalledWith(userId, 101, update.quantity);
    });
