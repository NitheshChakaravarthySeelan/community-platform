...
export declare class CartService {
    ...
    constructor(cartRepository: CartRepository, productServiceAdapter: ProductServiceAdapter);
    ...
    updateItemQuantity(userId: number, productId: number, quantity: number): Promise<Cart>;
